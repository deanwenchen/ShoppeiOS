    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            ZStack(alignment: .topLeading) {
                AsyncImage(url: URL(string: ImageURLProvider.getProductImageURL(for: product.imageColor))) { image in
                    image.resizable()
                ...
                Text(product.badge)
                    ...
                    .padding(.vertical, 4)
                    .background(product.badge == "Sale" ? Color(hex: "#FF6B6B") : Color(hex: "#004CFF"))
                    .cornerRadius(4)
                    .padding(4)
            }
